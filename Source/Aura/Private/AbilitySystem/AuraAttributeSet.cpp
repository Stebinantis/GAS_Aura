...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttributes.Add(GameplayTags.Attributes_Primary_Resillience, GetResillienceAttribute);
...
void UAuraAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	//Secondary attributes
	//Armor, ArmorPenetration, BlockChance, CriticalHitChance, CriticalHitDamage, CriticalHitResistance, HealthRegeneration, ManaRegeneration, MaxMana, MaxHealth
...
{
	// Source = causer of the effect, Target = the target of the effect (owner of this AS)
